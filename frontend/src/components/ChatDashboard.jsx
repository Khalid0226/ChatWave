...
function ChatDashboard({ user, onLogout }) {
  ...
  useEffect(() => {
    const handleReceiveMessage = (data) => {
      ...
      if (selectedChat && (data.sender === selectedChat._id || data.receiver === selectedChat._id)) {
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      const response = await API.post('/chat/send', {
        ...
        // Agar file upload ka logic alag se hai toh use yahan handle kar lena
      });

      if (response.status === 201) {
        // Naye message ko state me add kar do
      ...
      alert("Message bhejte waqt error aaya.");
    }
  };
            ...
            <>
              ...
              <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 z-10">
                {messages.map((msg) => (
                  ...
                  >
                    <div className={`max-w-[80%] md:max-w-md px-4 py-3 rounded-2xl text-xs leading-relaxed ${msg.sender === 'me'
